...
namespace
{
  ...
  mi::base::Handle<mi::neuraylib::IValue> _TranslateParameterValue(const mi::base::Handle<mi::neuraylib::IType_factory>& tf,
...
namespace gtl
{
                                                     ...
                                                     const McMaterialParameters& params)
  {
    ...
    if (!params.empty())
    {
      ...
      {
        mi::base::Handle<mi::neuraylib::IValue> value = _TranslateParameterValue(m_tf, m_vf, nameValuePair.second);
