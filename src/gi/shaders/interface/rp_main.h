...
GI_BINDING_INDEX(INSTANCE_TRANSFORMS, 11)

GI_BINDING_INDEX(AOV_CLEAR_VALUES_F, 12)
GI_BINDING_INDEX(AOV_CLEAR_VALUES_I, 13)

GI_BINDING_INDEX(AOV_COLOR,        14)
GI_BINDING_INDEX(AOV_NORMAL,       15)
GI_BINDING_INDEX(AOV_NEE,          16)
GI_BINDING_INDEX(AOV_BARYCENTRICS, 17)
GI_BINDING_INDEX(AOV_TEXCOORDS,    18)
GI_BINDING_INDEX(AOV_BOUNCES,      19)
GI_BINDING_INDEX(AOV_CLOCK_CYCLES, 20)
GI_BINDING_INDEX(AOV_OPACITY,      21)
GI_BINDING_INDEX(AOV_TANGENTS,     22)
GI_BINDING_INDEX(AOV_BITANGENTS,   23)
GI_BINDING_INDEX(AOV_THIN_WALLED,  24)
GI_BINDING_INDEX(AOV_OBJECT_ID,    25)
GI_BINDING_INDEX(AOV_DEPTH,        26)
GI_BINDING_INDEX(AOV_FACE_ID,      27)
GI_BINDING_INDEX(AOV_INSTANCE_ID,  28)
GI_BINDING_INDEX(AOV_DOUBLE_SIDED, 29)
