...
const GI_UINT BLAS_PREAMBLE_SCENE_DATA_BITFLAG_UNIFORM = 0x40000000u; //(1 << 30);
...
GI_BINDING_INDEX(AOV_CLEAR_VALUES_F, 9)
GI_BINDING_INDEX(AOV_CLEAR_VALUES_I, 10)

GI_BINDING_INDEX(AOV_COLOR,        11)
GI_BINDING_INDEX(AOV_NORMAL,       12)
GI_BINDING_INDEX(AOV_NEE,          13)
GI_BINDING_INDEX(AOV_BARYCENTRICS, 14)
GI_BINDING_INDEX(AOV_TEXCOORDS,    15)
GI_BINDING_INDEX(AOV_BOUNCES,      16)
GI_BINDING_INDEX(AOV_CLOCK_CYCLES, 17)
GI_BINDING_INDEX(AOV_OPACITY,      18)
GI_BINDING_INDEX(AOV_TANGENTS,     19)
GI_BINDING_INDEX(AOV_BITANGENTS,   20)
GI_BINDING_INDEX(AOV_THIN_WALLED,  21)
GI_BINDING_INDEX(AOV_OBJECT_ID,    22)
