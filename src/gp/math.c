...
{
  aabb_b->min[0] = fmin(aabb_a->min[0], v[0]);
  aabb_b->min[1] = fmin(aabb_a->min[1], v[1]);
  aabb_b->min[2] = fmin(aabb_a->min[2], v[2]);
  aabb_b->max[0] = fmax(aabb_a->max[0], v[0]);
  aabb_b->max[1] = fmax(aabb_a->max[1], v[1]);
  aabb_b->max[2] = fmax(aabb_a->max[2], v[2]);
}
